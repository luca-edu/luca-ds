...
export const Default: Story = {
  render: (args) => (
    <Template
      {...args}
      label="Ética"
      detail="Representaciones cartográficas de la comunidad"
    />
  ),
};
  ...
  render: (args) => (
    ...
    >
      ...
      <div className="luca-flex luca-flex-1 luca-items-center">
        <SelectorDetail>
          Mapas históricos de la región metropolitana
        </SelectorDetail>
      </div>
      <SelectorAction
...
export const RemoveAction: Story = {
  render: (args) => (
    ...
    >
      ...
      <div className="luca-flex luca-flex-1 luca-items-center">
        <SelectorDetail>
          Álgebra lineal aplicada al modelado de datos
        </SelectorDetail>
      </div>
      <SelectorAction
        aria-label="Remover"
