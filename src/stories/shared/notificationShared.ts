...
export const notificationCopy: Record<NotificationVariant, { title: string; description: string }> =
  {
    success: {
    ...
    warning: {
      ...
      description: 'Algunos campos requieren tu atención. Valida los datos antes de continuar.',
    },
    info: {
...
export const variantOptions: NotificationVariant[] = ['success', 'danger', 'warning', 'info'];
