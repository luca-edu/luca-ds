...
const backgroundColorStyles: Record<CardProductColor, Record<CardProductState, string>> = {
  primary: {
    ...
    hover: 'luca-bg-primary-100 luca-border luca-border-primary-600',
    disabled: 'luca-bg-neutral-100',
    blocked: '',
    exclusive: '',
    exclusiveHover: 'luca-bg-warning-200 luca-border luca-border-warning-600',
  },
  accent: {
    default: 'luca-border luca-border-white',
...
const bottomBackgroundColorStyles: Record<CardProductColor, Record<CardProductState, string>> = {
  primary: {
    default: 'luca-bg-primary-200',
    hover: '',
    disabled: '',
    blocked: '',
    exclusive: 'luca-bg-gradient-to-t luca-from-warning-300 luca-to-transparent',
    exclusiveHover: '',
  },
  accent: {
    ...
    disabled: '',
    blocked: '',
    exclusive: 'luca-bg-gradient-to-t luca-from-warning-200 luca-to-transparent',
    exclusiveHover: '',
  },
  success: {
...
const blockedBackgroundColorStyles: Record<CardProductColor, string> = {
  primary: 'luca-bg-primary-600/70',
  accent: 'luca-bg-accent-600/70',
  success: 'luca-bg-success-600/70',
  warning: 'luca-bg-warning-600/70',
  danger: 'luca-bg-danger-600/70',
  info: 'luca-bg-info-600/70',
  neutral: 'luca-bg-neutral-600/70',
};

// Estilos de sombra
const shadowStyles: Record<CardProductState, string> = {
  default: '',
  hover: 'luca-shadow-[0px_4px_10px_2px_rgba(65,81,234,0.3)]',
  disabled: '',
  blocked: '',
  exclusive: '',
  exclusiveHover: 'luca-shadow-[0px_4px_10px_0px_rgba(255,186,49,0.3)]',
};
